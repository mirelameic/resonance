...
export const works = [
  {
    ...
    image: null, imageCredit: null, source: { type: 'wikidata', sourceId: 'placeholder-1' },
  },
  {
    ...
    context: 'Released in 2002 in Brazil.',
    description: 'Placeholder entry pending the first real sync run.',
    image: null, imageCredit: null, source: { type: 'wikidata', sourceId: 'placeholder-2' },
  },
  {
    ...
    description: 'Placeholder entry pending the first real sync run.',
    image: null, imageCredit: null, source: { type: 'wikidata', sourceId: 'placeholder-3' },
  },
  {
    ...
    description: 'Placeholder entry pending the first real sync run.',
    image: null, imageCredit: null, source: { type: 'wikidata', sourceId: 'placeholder-4' },
  },
  {
    ...
    description: 'Placeholder entry pending the first real sync run.',
    image: null, imageCredit: null, source: { type: 'wikidata', sourceId: 'placeholder-5' },
  },
  {
    ...
    description: 'Placeholder entry pending the first real sync run.',
    image: null, imageCredit: null, source: { type: 'wikidata', sourceId: 'placeholder-6' },
  },
];
